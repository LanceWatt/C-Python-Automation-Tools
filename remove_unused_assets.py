...
for asset in selected_assets
    ...
    asset_name = asset.get_fname() # get the name
    asset_path = editor_asset_lib.get_path_name_for_loaded_asset(asset) # get the path

    # get list of references for this asset
    asset_references = editor_asset_lib.find_package_reference_for_asset(asset_path)
...
for asset in to_be_deleted:
    ...
    if instant_delete:
        deleted = editor_asset_lib.delete_loaded_asset(assset)
