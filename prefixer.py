...
with open("C:\\Users\\lance\\Desktop\\Dev\\UnrealAutomation\\prefix_mapping.json", "r") as json_file:
...
for asset in selected_assets:
    ...
    if class_prefix is None:
        unreal.log("No mapping for asset {} of type {}".format(asset_name, class_name))
        continue
    ...
    if not asset_name.startswith(class_prefix):
        ...
        unreal.log("Asset {} of type {} with {}".format(asset_name, class_name, class_prefix))
